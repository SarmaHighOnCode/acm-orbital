...
function Earth() {
  ...
  useFrame(() => {
      // ECEF Frame - Earth does not rotate visually, geographic lat/lon are plotted directly into scene
...
// Rotate ground stations with the Earth (ECEF frame = static)
    useFrame(() => {
      // ECEF Frame - static map
  });
